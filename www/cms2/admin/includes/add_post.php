<?php
    ...
    if(isset($_POST['create_post'])){
        ...
        $query = "INSERT INTO `posts`( `post_category_id`,`post_user_id`, `post_title`, `post_user`, `post_image`,
                           `post_content`, `post_date`, `post_tags`, `post_status`) 
              VALUES ({$post_category_id},{$post_user_id},'{$post_title}','{$post_user}','{$post_image}','{$post_content}',
