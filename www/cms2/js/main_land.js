...
function submitForm(n) {
    ...
    }), $("#Client_details" + t).submit()) : alert("Р’СЃРµ РїРѕР»СЏ РѕР±СЏР·Р°С‚РµР»СЊРЅС‹!!!")
}
...
function sendForms(n, t) {
    ...
    // var i = "";
    // i = 'Р§РµСЂРµР· 2 вЂ“ 3 РјРёРЅСѓС‚С‹ РЅР° СѓРєР°Р·Р°РЅРЅС‹Р№ email РїСЂРёРґРµС‚ РїРёСЃСЊРјРѕ СЃ РїРѕРґСЂРѕР±РЅРѕР№ РёРЅСЃС‚СЂСѓРєС†РёРµР№.  \n\nР•СЃР»Рё РїРёСЃСЊРјРѕ РЅРµ РїРѕСЏРІРёР»РѕСЃСЊ РІ РїР°РїРєРµ В«Р’С…РѕРґСЏС‰РёРµВ», РїСЂРѕРІРµСЂСЊС‚Рµ РїР°РїРєСѓ В«РЎРїР°РјВ».\n\nР•СЃР»Рё РІС‹ РЅРµ РїРѕР»СѓС‡РёР»Рё РїРёСЃСЊРјРѕ РІ С‚РµС‡РµРЅРёРµ 30 РјРёРЅСѓС‚, РїРѕР¶Р°Р»СѓР№СЃС‚Р°, РѕР±СЂР°С‚РёС‚РµСЃСЊ РІ С‚РµС…. РїРѕРґРґРµСЂР¶РєСѓ. \n\nРџРѕСЃР»Рµ РїРѕР»СѓС‡РµРЅРёСЏ РїРёСЃСЊРјР°: \n1. Р”РѕР±Р°РІСЊС‚Рµ Р°РґСЂРµСЃ РѕС‚РїСЂР°РІРёС‚РµР»СЏ РІ РєРѕРЅС‚Р°РєС‚С‹\n2. Р•СЃР»Рё РїРёСЃСЊРјРѕ РїРѕРїР°Р»Рѕ РІ РїР°РїРєСѓ В«РЎРїР°РјВ», РІС‹РґРµР»РёС‚Рµ РµРіРѕ Рё РЅР°Р¶РјРёС‚Рµ В«РќРµ СЃРїР°РјВ», С‡С‚РѕР±С‹  РІ РґР°Р»СЊРЅРµР№С€РµРј РіР°СЂР°РЅС‚РёСЂРѕРІР°РЅРЅРѕ РїРѕР»СѓС‡Р°С‚СЊ РІСЃСЋ РІР°Р¶РЅСѓСЋ РёРЅС„РѕСЂРјР°С†РёСЋ РїРѕ РїСЂРѕРµРєС‚Сѓ В«РћР±С‰РµРµ РґРµР»РѕВ».\n\nРќРµ Р·Р°Р±СѓРґСЊС‚Рµ РЅР°Р¶Р°С‚СЊ РєРЅРѕРїРєСѓ "РћРє"';
    // alert(i);
...
function SendReg(n, t, i, r, u, f, e) {
    if ($(".reg-btn").prop("disabled", !0), n === "" || t === "" || i === "" || r === "" || u === "" || f === "") {
        $("#" + e).text("Р’СЃРµ РїРѕР»СЏ РѕР±СЏР·Р°С‚РµР»СЊРЅС‹!");
        $(".reg-btn").prop("disabled", !1);
        return
    }
    if (!validateEmail(i)) {
        $("#" + e).text("Email РёРјРµРµС‚ РЅРµРІРµСЂРЅС‹Р№ С„РѕСЂРјР°С‚!");
        $(".reg-btn").prop("disabled", !1);
        return
    }
    LoaderOn();
...
$(function() {
    ...
    function i(t) {
        ...
        return u = n(100, 600), f = '<li class="review__item"><div class="review__user_photo"><img src="img/users/' + i + '.jpg" alt=""></div><div class="review__info"><div class="review__info_name">' + names[i] + '</div><div class="review__info_signature">С‚РѕР»СЊРєРѕ С‡С‚Рѕ Р·Р°СЂР°Р±РѕС‚Р°Р»(Р°)</div><div class="review__info_money">$ ' + u + "," + n(10, 99) + '</div></div></li>', [f, i]
    }
    ...
    names = ["Р’РёС‚Р°Р»РёР№", "РљРѕРЅСЃС‚Р°РЅС‚РёРЅ", "РђРЅРґСЂРµР№", "Р’Р°Р»РµРЅС‚РёРЅ", "Р“РµРѕСЂРіРёР№", "РќРёРєРѕР»Р°Р№", "Р”Р°РЅРёР»Р°", "Р’СЏС‡РµСЃР»Р°РІ", "РђР»РµРєСЃРµР№", "РќРёРєРѕР»Р°Р№", "Р РѕРјР°РЅ", "РЎС‚РµРїР°РЅ", "Р•РіРѕСЂ", "РќРёРєРёС‚Р°", "Р¤С‘РґРѕСЂ", "РђР»РµРєСЃР°РЅРґСЂ", "Р“СЂРёРіРѕСЂРёР№", "Р СѓСЃР»Р°РЅ", "Р СѓСЃР»Р°РЅ", "РЇСЂРѕСЃР»Р°РІ", "Р‘РѕРіРґР°РЅ", "РђРЅР°С‚РѕР»РёР№", "Р”РјРёС‚СЂРёР№", "Р¤РёР»РёРїРї", "РџС‘С‚СЂ", "РЎРµРјС‘РЅ", "РЇРЅ", "РђР»РµРєСЃР°РЅРґСЂ", "РџР°РІРµР»", "РЎРµРјС‘РЅ", "Р­Р»СЊРґР°СЂ", "РЎС‚РµРїР°РЅ", "Р­СЂРёРє", "РўРёРјРѕС„РµР№", "РЎС‚Р°РЅРёСЃР»Р°РІ", "Р’Р°Р»РµРЅС‚РёРЅ", "РРІР°РЅ", "Р РѕРјР°РЅ", "РќРёРєРёС‚Р°", "РР»СЊСЏ", "Р’Р°Р»РµСЂРёР№", "РўРёРјРѕС„РµР№", "РЎРІСЏС‚РѕСЃР»Р°РІ", "Р’Р»Р°РґРёРјРёСЂ", "РЎС‚Р°РЅРёСЃР»Р°РІ", "РђРЅР°С‚РѕР»РёР№", "Р’Р°Р»РµСЂРёР№", "РЇСЂРѕСЃР»Р°РІ", "РќРёРєРѕР»Р°Р№", "Р‘РѕСЂРёСЃ", "РРіРѕСЂСЊ", "РћР»РµРі", "РџС‘С‚СЂ", "Р•РіРѕСЂ", "Р’Р°Р»РµСЂРёР№", "Р’Р°СЃРёР»РёР№", "Р’СЏС‡РµСЃР»Р°РІ", "Р›РµРѕРЅРёРґ", "Р“РµРЅРЅР°РґРёР№", "РњР°РєСЃРёРј", "РђСЂС‚С‘Рј", "РЇРєРѕРІ", "Р РѕРјР°РЅ", "РњРёС…Р°РёР»", "РЎРµСЂРіРµР№", "РњРёС…Р°РёР»", "Р­РґСѓР°СЂРґ", "РћР»РµРі", "Р›РµРѕРЅРёРґ", "РР»СЊСЏ", "Р’Р°Р»РµРЅС‚РёРЅ", "Р’Р°СЃРёР»РёР№", "РЎС‚РµРїР°РЅ", "Р СѓСЃР»Р°РЅ", "РџС‘С‚СЂ", "Р›РµРІ", "РђРЅС‚РѕРЅ", "Р”Р°РЅРёРёР»", "РђСЂРєР°РґРёР№", "РђСЂС‚С‘Рј", "Р РѕРјР°РЅ", "РђРЅР°С‚РѕР»РёР№", "РўРёРјСѓСЂ", "РџР°РІРµР»", "РњРёС…Р°РёР»", "Р СѓСЃС‚Р°Рј", "Р’Р»Р°РґРёСЃР»Р°РІ", "РђРЅРґСЂРµР№", "РњРёС…Р°РёР»", "РђР»РµРєСЃРµР№", "Р РѕР±РµСЂС‚", "РЇРєРѕРІ", "Р¤РёР»РёРїРї", "РЎРµСЂРіРµР№", "Р›РµРІ", "Р“Р»РµР±", "РњР°РєСЃРёРј", "РђР»РµРєСЃР°РЅРґСЂ", "РњРёС…Р°РёР»", "Р’РёРєС‚РѕСЂ", "Р”РµРЅРёСЃ", "РЎРµСЂРіРµР№", "Р’Р°СЃРёР»РёР№", "Р›РµРѕРЅРёРґ", "РР»СЊСЏ", "РђР»РµРєСЃРµР№", "Р’Р°Р»РµСЂРёР№", "РќРёРєРёС‚Р°", "РћР»СЊРіР°", "РСЂРёРЅР°", "Р’РёРєС‚РѕСЂРёСЏ", "РђР»С‘РЅР°", "РђР»РёРЅР°", "Р’РµСЂРѕРЅРёРєР°", "Р›СЋР±РѕРІСЊ", "РђР»РµРІС‚РёРЅР°", "РњР°СЂРіР°СЂРёС‚Р°", "Р›РёР»РёСЏ", "РђРЅРіРµР»РёРЅР°", "РўР°РёСЃРёСЏ", "РђРЅРЅР°", "РњР°СЂРёСЏ", "Р®Р»РёСЏ", "РњР°СЂРёСЏ", "РђРЅРЅР°", "РђР»РµРєСЃР°РЅРґСЂР°", "Р•Р»РёР·Р°РІРµС‚Р°", "Р’РµСЂРѕРЅРёРєР°", "Р•РєР°С‚РµСЂРёРЅР°", "Р’Р°Р»РµСЂРёСЏ", "РђР»РёРЅР°", "РњР°СЂРёРЅР°", "РџРѕР»РёРЅР°", "РњР°СЂРіР°СЂРёС‚Р°", "Р®Р»РёСЏ", "РќР°С‚Р°Р»СЊСЏ", "РЎРІРµС‚Р»Р°РЅР°", "РСЂРёРЅР°", "РЇРЅР°", "РњР°СЂРёРЅР°", "РћР»СЊРіР°", "РўР°С‚СЊСЏРЅР°", "РРЅРЅР°", "РЎРІРµС‚Р»Р°РЅР°", "Р›Р°СЂРёСЃР°", "Р’РµСЂР°", "Р•РІРіРµРЅРёСЏ", "Р­Р»РµРѕРЅРѕСЂР°", "Р•Р»РµРЅР°", "РђРЅС‚РѕРЅРёРЅР°", "РЎРІРµС‚Р»Р°РЅР°", "Р’Р°Р»РµРЅС‚РёРЅР°", "РђР»РµРєСЃР°РЅРґСЂР°", "Р›СЋР±РѕРІСЊ", "РћР»СЊРіР°", "РљСЂРёСЃС‚РёРЅР°", "Р’РёРєС‚РѕСЂ", "РЎРµСЂРіРµР№", "РђРЅР°С‚РѕР»РёР№", "РђРЅС‚РѕРЅ", "Р’РёС‚Р°Р»РёР№", "Р“Р»РµР±", "РђР»РµРєСЃР°РЅРґСЂ", "РњР°СЂРє", "РђР»РµРєСЃРµР№", "РџР°РІРµР»", "РќРёРєРѕР»Р°Р№", "Р”Р°РІРёРґ", "РњР°РєСЃРёРј", "РћР»РµРі", "РђР»РµРєСЃР°РЅРґСЂ", "РђСЂС‚РµРј", "Р’Р°СЃРёР»РёР№", "РњР°С‚РІРµР№", "РђСЂСЃРµРЅ", "Р“СЂРёРіРѕСЂРёР№", "РРІР°РЅ", "Р’РёС‚Р°Р»РёР№", "Р›РµРІ", "Р’Р»Р°РґРёСЃР»Р°РІ", "РРІР°РЅ", "РЎРµСЂРіРµР№", "Р’СЏС‡РµСЃР»Р°РІ", "РќРёРєРёС‚Р°", "РЎРІСЏС‚РѕСЃР»Р°РІ", "Р”РјРёС‚СЂРёР№", "РЎС‚РµРїР°РЅ", "Р•РІРіРµРЅРёР№", "РђР»РµРєСЃРµР№", "РР»СЊСЏ", "РЎРµСЂРіРµР№", "Р•РІРіРµРЅРёР№", "РњРёС…Р°РёР»", "Р“РµРѕСЂРіРёР№"];
    (new WOW).init();
